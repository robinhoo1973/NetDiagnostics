// =============================================================================
// DesktopNetworkController.h — Desktop G1/G2/G3 via existing C++ code
// =============================================================================
#pragma once
#include "controllers/INetworkController.h"

class DesktopNetworkController : public INetworkController {
public:
    DesktopNetworkController() = default;
    ...
    QString controllerName() const override { return QStringLiteral("DesktopNetwork"); }
};
