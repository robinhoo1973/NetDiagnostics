...
RowLayout {
    ...
    // 5WHY: Locked only on Premium platforms (iOS/Android/macOS).  On
    // Windows/Linux sharing is FREE — buttons stay enabled and share directly
    ...
    Component {
        ...
        Item {
            ...
            MouseArea {
                ...
                onClicked: shareRoot.locked
                    ? shareRoot.premiumRequired()
                    : shareRoot.shareRequested(bareRoot.formatTag)
            }
    ...
    Component {
        ...
        Rectangle {
            ...
            MouseArea {
                ...
                onClicked: shareRoot.locked
                    ? shareRoot.premiumRequired()
                    : shareRoot.shareRequested(parent.formatTag)
            }
