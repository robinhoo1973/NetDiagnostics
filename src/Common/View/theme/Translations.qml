...
Item {
    ...
    readonly property string reportPlaceholder: t("Run diagnostics to generate a detailed report.\nExport to PDF or HTML when complete.", "Exécutez les diagnostics pour générer un rapport\ndétaillé. Exportez en PDF ou HTML une fois terminé.", "Führen Sie Diagnosen aus, um einen detaillierten\nBericht zu erstellen. Export als PDF oder HTML.", "Запустите диагностику для создания подробного\nотчёта. Экспорт в PDF или HTML по завершении.", "Esegui la diagnostica per generare un report\ndettagliato. Esporta in PDF o HTML al termine.", "运行诊断以生成详细报告。\n完成后导出为PDF或HTML。", "執行診斷以生成詳細報告。\n完成後匯出為PDF或HTML。", "Ejecute diagnósticos para generar un informe\ndetallado. Exporte a PDF o HTML al finalizar.", "Execute diagnósticos para gerar um relatório\ndetalhado. Exporte para PDF ou HTML ao concluir.")
    ...
    // ── Test names (44 entries, ids 0-43) ──
    function diagName(id) {
        ...
        var names = {
            ...
            24: t("URL Parsing", "Analyse d'URL", "URL-Analyse", "Парсинг URL", "Analisi URL", "URL解析", "URL解析", "Análisis de URL", "Análise de URL"),
            25: t("TCP Connect", "Connexion TCP", "TCP-Verbindung", "TCP соединение", "Connessione TCP", "TCP连接", "TCP連接", "Conexión TCP", "Conexão TCP"),
            26: t("Service Banner", "Bannière de service", "Service-Banner", "Баннер сервиса", "Banner del servizio", "服务横幅", "服務橫幅", "Banner de servicio", "Banner de serviço"),
            27: t("HTTP Request", "Requête HTTP", "HTTP-Anfrage", "HTTP запрос", "Richiesta HTTP", "HTTP请求", "HTTP請求", "Solicitud HTTP", "Requisição HTTP"),
            28: t("HTTP Headers", "En-têtes HTTP", "HTTP-Header", "HTTP заголовки", "Intestazioni HTTP", "HTTP头", "HTTP標頭", "Encabezados HTTP", "Cabeçalhos HTTP"),
            29: t("Security Headers", "En-têtes de sécurité", "Sicherheitsheader", "Заголовки безопасности", "Intestazioni sicurezza", "安全头", "安全標頭", "Encabezados de seguridad", "Cabeçalhos de segurança"),
            30: t("SSL Certificate", "Certificat SSL", "SSL-Zertifikat", "SSL сертификат", "Certificato SSL", "SSL证书", "SSL憑證", "Certificado SSL", "Certificado SSL"),
            31: t("HTTP Redirect", "Redirection HTTP", "HTTP-Weiterleitung", "HTTP редирект", "Reindirizzamento HTTP", "HTTP重定向", "HTTP重定向", "Redirección HTTP", "Redirecionamento HTTP"),
            32: t("HTTP Compression", "Compression HTTP", "HTTP-Komprimierung", "HTTP сжатие", "Compressione HTTP", "HTTP压缩", "HTTP壓縮", "Compresión HTTP", "Compressão HTTP"),
            33: t("HTTP Timing", "Chronométrage HTTP", "HTTP-Timing", "HTTP тайминг", "Temporizzazione HTTP", "HTTP计时", "HTTP計時", "Tiempos HTTP", "Tempos HTTP"),
            34: t("FTP Diagnostics", "Diagnostics FTP", "FTP-Diagnose", "FTP диагностика", "Diagnostica FTP", "FTP诊断", "FTP診斷", "Diagnóstico FTP", "Diagnóstico FTP"),
            35: t("SSH Diagnostics", "Diagnostics SSH", "SSH-Diagnose", "SSH диагностика", "Diagnostica SSH", "SSH诊断", "SSH診斷", "Diagnóstico SSH", "Diagnóstico SSH"),
            36: t("Email Diagnostics", "Diagnostics email", "E-Mail-Diagnose", "Диагностика почты", "Diagnostica email", "电子邮件诊断", "電子郵件診斷", "Diagnóstico de correo", "Diagnóstico de e-mail"),
            37: t("Telnet", "Telnet", "Telnet", "Telnet", "Telnet", "Telnet", "Telnet", "Telnet", "Telnet"),
            38: t("MySQL", "MySQL", "MySQL", "MySQL", "MySQL", "MySQL", "MySQL", "MySQL", "MySQL"),
            39: t("PostgreSQL", "PostgreSQL", "PostgreSQL", "PostgreSQL", "PostgreSQL", "PostgreSQL", "PostgreSQL", "PostgreSQL", "PostgreSQL"),
            40: t("Redis", "Redis", "Redis", "Redis", "Redis", "Redis", "Redis", "Redis", "Redis"),
            41: t("MongoDB", "MongoDB", "MongoDB", "MongoDB", "MongoDB", "MongoDB", "MongoDB", "MongoDB", "MongoDB"),
            42: t("LDAP", "LDAP", "LDAP", "LDAP", "LDAP", "LDAP", "LDAP", "LDAP", "LDAP"),
            43: t("MQTT", "MQTT", "MQTT", "MQTT", "MQTT", "MQTT", "MQTT", "MQTT", "MQTT"),
        }
        return typeof names[id] === 'string' ? names[id] : ""
    }
    // ── Test descriptions (44 entries, ids 0-43) ──
