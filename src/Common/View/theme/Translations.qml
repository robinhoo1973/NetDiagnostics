...
Item {
    ...
    function diagName(id) {
        ...
        var names = {
            ...
            26: t("URL Parsing", "Analyse d'URL", "URL-Analyse", "Парсинг URL", "Analisi URL", "URL解析", "URL解析", "Análisis de URL", "Análise de URL"),
            27: t("TCP Connect", "Connexion TCP", "TCP-Verbindung", "TCP соединение", "Connessione TCP", "TCP连接", "TCP連接", "Conexión TCP", "Conexão TCP"),
            28: t("Service Banner", "Bannière de service", "Service-Banner", "Баннер сервиса", "Banner del servizio", "服务横幅", "服務橫幅", "Banner de servicio", "Banner de serviço"),
