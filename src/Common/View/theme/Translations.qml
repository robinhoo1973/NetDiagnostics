...
Item {
    ...
    function diagName(id) {
        ...
        var names = {
            ...
            17: t("DNS Integrity", "Intégrité DNS", "DNS-Integrität", "Целостность DNS", "Integrità DNS", "DNS可信度", "DNS可信度", "Integridad DNS", "Integridade DNS"),
    ...
    function diagDesc(id) {
        ...
        var descs = {
            ...
            38: t("Telnet service reachability and login banner", "Accessibilité du service Telnet et bannière de connexion", "Telnet-Diensterreichbarkeit und Login-Banner", "Доступность сервиса Telnet и баннер входа", "Raggiungibilità servizio Telnet e banner login", "Telnet服务可达性和登录横幅", "Telnet服務可達性和登入橫幅", "Accesibilidad del servicio Telnet y banner de inicio de sesión", "Acessibilidade do serviço Telnet e banner de login"),
            39: t("MySQL server reachability and version detection", "Accessibilité du serveur MySQL et détection de version", "MySQL-Server-Erreichbarkeit und Versionserkennung", "Доступность сервера MySQL и обнаружение версии", "Raggiungibilità server MySQL e rilevamento versione", "MySQL服务器可达性和版本检测", "MySQL伺服器可達性和版本偵測", "Accesibilidad del servidor MySQL y detección de versión", "Acessibilidade do servidor MySQL e detecção de versão"),
            40: t("PostgreSQL server reachability and version detection", "Accessibilité du serveur PostgreSQL et détection de version", "PostgreSQL-Server-Erreichbarkeit und Versionserkennung", "Доступность сервера PostgreSQL и обнаружение версии", "Raggiungibilità server PostgreSQL e rilevamento versione", "PostgreSQL服务器可达性和版本检测", "PostgreSQL伺服器可達性和版本偵測", "Accesibilidad del servidor PostgreSQL y detección de versión", "Acessibilidade do servidor PostgreSQL e detecção de versão"),
    ...
    readonly property string captureScreenshotOnly: t("Screenshot Only", "Capture d'écran seule", "Nur Screenshot", "Только скриншот", "Solo screenshot", "仅截图", "僅截圖", "Solo captura", "Apenas captura")
    readonly property string captureRecordingOnly: t("Recording Only", "Enregistrement seul", "Nur Aufnahme", "Только запись", "Solo registrazione", "仅录屏", "僅錄屏", "Solo grabación", "Apenas gravação")
    readonly property string captureBoth: t("Both (Recommended)", "Les deux (recommandé)", "Beides (empfohlen)", "Оба (рекомендуется)", "Entrambi (consigliato)", "截图+录屏（推荐）", "截圖+錄屏（推薦）", "Ambos (recomendado)", "Ambos (recomendado)")
    ...
    readonly property string captureDoNotTouch: t("Please do not touch the device", "Veuillez ne pas toucher l'appareil", "Bitte Gerät nicht berühren", "Пожалуйста, не трогайте устройство", "Si prega di non toccare il dispositivo", "请勿触碰设备", "請勿觸碰設備", "No toque el dispositivo", "Não toque no dispositivo")
    readonly property string captureDndHint: t("Enable Do Not Disturb mode", "Activez le mode Ne pas déranger", "Bitte Nicht-stören-Modus aktivieren", "Включите режим «Не беспокоить»", "Attiva modalità Non disturbare", "请开启勿扰模式", "請開啟勿擾模式", "Active el modo No molestar", "Ative o modo Não perturbe")
    readonly property string captureScreenAwake: t("Screen will stay awake", "L'écran restera allumé", "Bildschirm bleibt an", "Экран не погаснет", "Lo schermo resterà acceso", "屏幕将保持常亮", "螢幕將保持常亮", "La pantalla permanecerá encendida", "A tela permanecerá ligada")
    readonly property string captureEstTime: t("Estimated time: ~45 seconds", "Temps estimé : ~45 secondes", "Geschätzte Zeit: ~45 Sekunden", "Примерное время: ~45 секунд", "Tempo stimato: ~45 secondi", "预计时间：约45秒", "預計時間：約45秒", "Tiempo estimado: ~45 segundos", "Tempo estimado: ~45 segundos")
    readonly property string captureCancelBtn: t("Cancel Capture", "Annuler", "Aufnahme abbrechen", "Отменить захват", "Annulla cattura", "取消采集", "取消採集", "Cancelar captura", "Cancelar captura")
