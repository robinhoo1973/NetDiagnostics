...
static const DiagnosticMeta kDiagMeta[] = {
    ...
    { DiagId::G3InternetConnectivity, "Internet Connectivity & Speed", "nd-diag-g3-internet", PF_All,        DiagAnimType::Lock,   DiagTemplateType::Handshake, metricOnly("downloadMbpsBest","Mbps",1,DP::Gauge), 180000 },

    // ── G4  Remote Host (all platforms — NEW-1) ─────────────────────────────
    { DiagId::G4DnsResolution,     "DNS Resolution",     "nd-diag-g4-dns-resolution",  PF_All,                       DiagAnimType::Bounce, DiagTemplateType::System, sys("queryTimeMs","ms",0), 60000 },
    ...
    { DiagId::G4PathPing,          "PathPing",           "nd-diag-g4-pathping",    PF_All,                       DiagAnimType::Bounce, DiagTemplateType::Path,   metricOnly("hopCount","hops",0,DP::BarChart,"hops"), 120000 },
    ...
    { DiagId::G5CurlVerbose,       "HTTP Request",       "nd-diag-g5-curl-verbose", PF_All,                       DiagAnimType::Type,   DiagTemplateType::Request, []{ DP d = metricOnly("totalMs","ms",0,DP::BarChart,"waterfall"); d.showProperties=false; return d; }(), 120000 },
    ...
    { DiagId::G5FtpDiagnostics,    "FTP Diagnostics",    "nd-diag-g5-ftp",          PF_All,                       DiagAnimType::Pulse,  DiagTemplateType::Query,  metricOnly("latencyMs","ms",0,DP::Gauge), 60000 },
    ...
    { DiagId::G5Telnet,            "Telnet",             "nd-diag-g5-telnet",       PF_All,                       DiagAnimType::Path,   DiagTemplateType::Query,  metricOnly("latencyMs","ms",0,DP::Gauge), 60000 },
    ...
    { DiagId::G5Ldap,              "LDAP",               "nd-diag-g5-ldap",         PF_Desktop,                 DiagAnimType::Type,   DiagTemplateType::Query,  metricOnly("latencyMs","ms",0,DP::Gauge), 60000 },
