#!/usr/bin/env python3
"""CI HTTP test server — serves HTTP with security headers on port 8888.

5WHY: The startup crash test (ND_AUTO_TEST=1) runs G5 HTTP diagnostics
against the target host.  httpbin.org was an uncontrolled external
dependency — if it was down or rate-limited, CI would fail for reasons
